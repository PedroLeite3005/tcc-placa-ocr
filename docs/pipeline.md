# Pipeline completo — TCC OCR de placas (BJ7)
...
flowchart TB
    ...
    Split -->|"training: 16000 tracks (160000 imgs)"| Split
    Split -->|"validation: 4000 tracks (40000 imgs)"| Split
    Split -->|"testing: 3000 tracks (15000 imgs LR)"| Split
```
